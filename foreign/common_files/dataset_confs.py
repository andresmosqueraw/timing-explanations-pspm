...
# timing-explanations-pspm: the only edit to Shoush & Dumas's file -- the
# prepared logs live under paths.PREPARED_LOGS (env TIMING_PREPARED_LOGS)
# instead of their machine's absolute path.
import sys as _sys
from pathlib import Path as _Path
_sys.path.insert(0, str(_Path(__file__).resolve().parents[2]))
import paths as _paths  # noqa: E402
logs_dir = str(_paths.PREPARED_LOGS) + "/"
